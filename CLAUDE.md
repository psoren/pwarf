...
- **After merging, remove the worktree.** Run `git worktree remove .claude/worktrees/<name>` from the repo root, then `git branch -d <branch>` to delete the local branch.
