...
export default function RightPanel({ collapsed, onToggle, events, mode, locations = [], onLocationClick }: RightPanelProps) {
  const tabs: Tab[] = mode === "world" ? ["Log", "Legends"] : ["Log", "Legends", "Locations"];
